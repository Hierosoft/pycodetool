        ...
        while line_index < len(self.lines):
            ...
            if line_strip[:1] != "#":
                ...
                if line_strip[0:len(import_net_framework)] == import_net_framework:
                    ...
                    # must be detected in reverse order to preserve None
                    # value when previous line is not present
                    ...
                    if enumerator_current_index >= 0:
                        if enumerator_loop_indent is not None:
                            ...
                            # should already by fully qualified, else
                            # show error intentionally:
